...
class _LoanDetailScreenState extends State<LoanDetailScreen> {
  ...
  final PaymentRepository _paymentRepository = PaymentRepository(); //⚠️ AÑADIDO: Repositorio de pagos
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // ⚠️ AHORA USAMOS LOS VALORES DEL MODELO
                          Text(
                  ...
                  // Botones de contacto
                  if (_currentLoan.phoneNumber != null || _currentLoan.whatsappNumber != null)
                    Card(
                      elevation: 4,
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                      child: Padding(
                  ...
                  _isLoading
                      ? const Center(child: CircularProgressIndicator())
                      : _currentLoan.payments.isEmpty
                          ? const Center(child: Text('No hay pagos registrados.'))
                          : ListView.builder(
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              itemCount: _currentLoan.payments.length,
                              itemBuilder: (context, index) {
                                final payment = _currentLoan.payments[index];
                                return Dismissible(
                                  key: Key(payment.id),
                                  ...
                                  confirmDismiss: (direction) async {
                                    ...
                                    if (confirmDelete == true) {
                                      // ⚠️ LÓGICA CORRECTA PARA ELIMINAR EL PAGO
                                      try {
                                        await _paymentRepository.deletePayment(payment.id);
                                        // Recarga el préstamo para actualizar la vista
